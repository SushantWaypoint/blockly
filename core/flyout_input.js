...
goog.provide('Blockly.FlyoutInput');
 ...
 * @constructor
 */
Blockly.FlyoutInput = function(workspace, targetWorkspace, xml) {
  ...
  var callbackKey = xml.getAttribute('callbackKey');
    if (!(callbackKey && targetWorkspace.getButtonCallback(callbackKey))) {
 ...
 */
Blockly.FlyoutInput.MARGIN = 5;

/**
 * The width of the button's rect.
 * @type {number}
 */
Blockly.FlyoutInput.prototype.width = 0;

/**
 * The height of the button's rect.
 * @type {number}
 */
Blockly.FlyoutInput.prototype.height = 0;

/**
 * Create the button elements.
 * @return {!Element} The button's SVG group.
 */
Blockly.FlyoutInput.prototype.createDom = function() {
  ...
  var textarea = new goog.ui.Textarea(this.text_);
  
  textarea.setParent(this.svgGroup_);
  textarea = textarea.createDom();

  this.width = 16 * Blockly.FlyoutInput.MARGIN;
 ...
 */
Blockly.FlyoutInput.prototype.show = function() {
  this.updateTransform_();
 ...
 * @private
 */
Blockly.FlyoutInput.prototype.updateTransform_ = function() {
 ...
 */
Blockly.FlyoutInput.prototype.moveTo = function(x, y) {
  this.position_.x = x;
  this.position_.y = y;
  this.updateTransform_();
};
 ...
 *     button resides.
 */
Blockly.FlyoutInput.prototype.getTargetWorkspace = function() {
 ...
 */
Blockly.FlyoutInput.prototype.dispose = function() {
  if (this.svgGroup_) {
 ...
 */
Blockly.FlyoutInput.prototype.onMouseUp = function(e) {
